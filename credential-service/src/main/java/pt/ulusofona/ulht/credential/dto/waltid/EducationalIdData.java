...
public class EducationalIdData {
    ...
    @Schema(description = "SCHAC Personal Unique Codes", 
            example = "[\"urn:schac:personalUniqueCode:int:esi:urn:esid:ulusofona.pt:511114706\"]")
    private List<String> schacPersonalUniqueCode;
    
    @Schema(description = "SCHAC Personal Unique ID", 
            example = "urn:schac:personalUniqueID:PT:ulusofona.pt:511114706")
    private String schacPersonalUniqueID;
    
    @Schema(description = "SCHAC Home Organization", example = "ulusofona.pt")
    ...
    @Schema(description = "Email address", example = "luisa.costa@alunos.ulusofona.pt")
    private String mail;
