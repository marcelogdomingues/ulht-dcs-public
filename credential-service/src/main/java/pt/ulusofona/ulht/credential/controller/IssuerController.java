...
import pt.ulusofona.ulht.credential.service.issuer.SessionCredentialService;
import pt.ulusofona.ulht.credential.service.issuer.SessionService;
...
public class IssuerController {
    ...
    public ResponseEntity<List<Map<String, Object>>> getRegisteredStudents(@PathVariable String sessionId) {
        ...
        List<pt.ulusofona.ulht.credential.domain.issuer.RegisteredStudent> students = 
    ...
    private Map<String, Object> registeredStudentToMap(pt.ulusofona.ulht.credential.domain.issuer.RegisteredStudent student) {
        Map<String, Object> map = new HashMap<>();
