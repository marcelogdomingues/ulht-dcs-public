...
public class HealthController {
                ...
                examples = {
                    @ExampleObject(
                        ...
                        value = """
                        {
                          ...
                          "service": "ULHT Credential Service",
                          "version": "1.0.0",
                          "uptime": "2h 15m 30s",
                          "components": {
                            "database": "UP",
    ...
    public ResponseEntity<Map<String, Object>> getSystemHealth() {
        ...
        health.put("service", "ULHT Credential Service");
                    ...
                    @ExampleObject(
                        ...
                        value = """
                        {
                          ...
                          "build": {
                            ...
                            "artifact": "ulht-credential-service",
                            "group": "pt.ulusofona",
                            "name": "ulht-credential-service"
                          },
                          "java": {
                            "version": "23",
    ...
    public ResponseEntity<Map<String, Object>> getSystemInfo() {
        ...
        info.put("service", "ULHT Credential Service");
    ...
    public ResponseEntity<Map<String, Object>> ping() {
        ...
        response.put("service", "ULHT Credential Service");
