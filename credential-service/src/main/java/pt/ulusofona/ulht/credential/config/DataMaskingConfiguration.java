...
import pt.ulusofona.ulht.credential.util.DataMasker;
...
public class DataMaskingConfiguration {
    ...
    public KafkaDataMaskingInterceptor kafkaDataMaskingInterceptor(
        ...
        // Initialize static holders so Kafka-instantiated interceptors can access them
        KafkaDataMaskingInterceptor.setStaticDataMasker(dataMasker);
        KafkaDataMaskingInterceptor.setStaticConfig(config);
        
        // Return instance for Spring context (though Kafka will create its own instances)
