package pt.ulusofona.ulht.credential.mapper;

import lombok.extern.slf4j.Slf4j;
import pt.ulusofona.ulht.credential.dto.EducationalIdCredentialRequest;
import pt.ulusofona.ulht.credential.dto.EuropeanStudentCardRequest;
import pt.ulusofona.ulht.credential.dto.UniversityDegreeCredentialRequest;

import java.util.Arrays;
import java.util.Map;

/**
 * Maps student data from Lusofona Service to credential requests
 */
@Slf4j
public class StudentDataMapper {
    
    private static final String DEFAULT_HOME_ORGANIZATION = "ulusofona.pt";
    private static final String DEFAULT_INSTITUTION_NAME = "ULHT - Universidade Lusófona";
