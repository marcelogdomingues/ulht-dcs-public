...
import com.example.dcs.credential.exception.ValidationException;
import com.example.dcs.credential.exception.TimeoutException;
import com.example.dcs.credential.exception.ConflictException;
import com.example.dcs.credential.exception.ForbiddenException;
import com.example.dcs.credential.exception.UnauthorizedException;
import com.example.dcs.credential.exception.BadRequestException;
import com.example.dcs.credential.exception.NotFoundException;
...
public class WaltidController {
    ...
    public String issueJwtCredential(@RequestBody Object requestBody) throws ValidationException, ExternalServiceException, TimeoutException, ConflictException, ForbiddenException, UnauthorizedException, BadRequestException, NotFoundException {
        ...
        try {
            ...
            if (requestBody instanceof com.example.dcs.credential.dto.waltid.IssueCredentialRequest) {
                return waltidService.issueJwtCredential(
                    (com.example.dcs.credential.dto.waltid.IssueCredentialRequest) requestBody);
            }
    ...
    public String issueUniversityDegreeCredential(@RequestBody com.example.dcs.credential.dto.UniversityDegreeCredentialRequest request) throws ValidationException, ExternalServiceException, TimeoutException, ConflictException, ForbiddenException, UnauthorizedException, BadRequestException, NotFoundException {
    ...
    @ApiResponses(value = {
        @ApiResponse(
            ...
            content = @Content(
                schema = @Schema(implementation = com.example.dcs.credential.dto.waltid.OnboardIssuerResponse.class)
            )
        ),
        @ApiResponse(
            responseCode = "400",
    ...
    public com.example.dcs.credential.dto.waltid.OnboardIssuerResponse onboardIssuer(
        ...
        try {
            com.example.dcs.credential.dto.waltid.OnboardIssuerResponse response = 
    ...
    @io.swagger.v3.oas.annotations.parameters.RequestBody(
        ...
        required = true,
        content = @Content(
            schema = @Schema(implementation = com.example.dcs.credential.dto.waltid.IssueCredentialRequest.class)
        )
    )
    @ApiResponses(value = {
        @ApiResponse(
    ...
    public String issueW3cJwtCredential(
            @RequestBody com.example.dcs.credential.dto.waltid.IssueCredentialRequest request)
            throws ValidationException, ExternalServiceException {
    ...
    @io.swagger.v3.oas.annotations.parameters.RequestBody(
        ...
        required = true,
        content = @Content(
            schema = @Schema(implementation = com.example.dcs.credential.dto.EducationalIdCredentialRequest.class),
            examples = @ExampleObject(
    ...
    public String issueEducationalIdCredential(
            @RequestBody com.example.dcs.credential.dto.EducationalIdCredentialRequest request)
            throws ValidationException, ExternalServiceException {
    ...
    @io.swagger.v3.oas.annotations.parameters.RequestBody(
        ...
        required = true,
        content = @Content(
            schema = @Schema(implementation = com.example.dcs.credential.dto.EuropeanStudentCardRequest.class),
            examples = @ExampleObject(
                ...
                value = """
                {
                  "givenName": "Luísa",
                  "familyName": "Costa",
                  "email": "luisa.costa@aluno.usis.pt",
                  "esi": "ESI-3618254416",
                  "escn": "511114706",
    ...
    public String issueEuropeanStudentCard(
            @RequestBody com.example.dcs.credential.dto.EuropeanStudentCardRequest request)
            throws ValidationException, ExternalServiceException {
