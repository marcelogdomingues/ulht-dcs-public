            ...
            switch (response.status()) {
                case 400:
                    return new ExternalServiceException(
                        com.example.dcs.credential.exception.ErrorCodes.WALTID_BAD_REQUEST.getDescription() + 
                        (errorMessage != null ? " - " + errorMessage : ""), 
                        "WaltID", 
                        com.example.dcs.credential.exception.ErrorCodes.WALTID_BAD_REQUEST.getCode()
                    );
                case 401:
                    // Include the actual error message (e.g., "Unknown user") in the exception
                    String unauthorizedMsg = com.example.dcs.credential.exception.ErrorCodes.WALTID_UNAUTHORIZED.getDescription();
                    ...
                    return new ExternalServiceException(
                        unauthorizedMsg, 
                        "WaltID", 
                        com.example.dcs.credential.exception.ErrorCodes.WALTID_UNAUTHORIZED.getCode()
                    );
                case 403:
                    return new ExternalServiceException(
                        com.example.dcs.credential.exception.ErrorCodes.WALTID_FORBIDDEN.getDescription() + 
                        (errorMessage != null ? " - " + errorMessage : ""), 
                        "WaltID", 
                        com.example.dcs.credential.exception.ErrorCodes.WALTID_FORBIDDEN.getCode()
                    );
                case 404:
                    return new ExternalServiceException(
                        com.example.dcs.credential.exception.ErrorCodes.WALTID_NOT_FOUND.getDescription() + 
                        (errorMessage != null ? " - " + errorMessage : ""), 
                        "WaltID", 
                        com.example.dcs.credential.exception.ErrorCodes.WALTID_NOT_FOUND.getCode()
                    );
                case 409:
                    return new ExternalServiceException(
                ...
                case 500:
                    return new ExternalServiceException(
                        com.example.dcs.credential.exception.ErrorCodes.WALTID_SERVER_ERROR.getDescription() + 
                        (errorMessage != null ? " - " + errorMessage : ""), 
                        "WaltID", 
                        com.example.dcs.credential.exception.ErrorCodes.WALTID_SERVER_ERROR.getCode()
                    );
                case 503:
                    return new ExternalServiceException(
                        com.example.dcs.credential.exception.ErrorCodes.WALTID_UNAVAILABLE.getDescription() + 
                        (errorMessage != null ? " - " + errorMessage : ""), 
                        "WaltID", 
                        com.example.dcs.credential.exception.ErrorCodes.WALTID_UNAVAILABLE.getCode()
                    );
                default:
                    return new ExternalServiceException(
