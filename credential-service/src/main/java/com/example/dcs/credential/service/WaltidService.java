...
import com.example.dcs.credential.domain.authentication.LoginRequest;
import com.example.dcs.credential.domain.authentication.LoginResponse;
import com.example.dcs.credential.domain.authentication.RegisterRequest;
import com.example.dcs.credential.domain.authentication.RegisterResponse;
import com.example.dcs.credential.domain.wallet.WalletAccountResponse;
import com.example.dcs.credential.domain.wallet.WalletKeysResponse;
import com.example.dcs.credential.domain.wallet.WalletDidResponse;
import com.example.dcs.credential.exception.ExternalServiceException;
import com.example.dcs.credential.kafka.WalletEventProducer;
...
public class WaltidService {
    ...
    @Retry(name = "waltid")
    public com.example.dcs.credential.dto.waltid.OnboardIssuerResponse onboardIssuer(
        ...
        com.example.dcs.credential.dto.waltid.KeyConfig keyConfig = 
            com.example.dcs.credential.dto.waltid.KeyConfig.builder()
                .backend("jwk")
                .keyType(keyType)
                .build();
        
        com.example.dcs.credential.dto.waltid.DidConfig didConfig = 
            com.example.dcs.credential.dto.waltid.DidConfig.builder()
                .method(didMethod)
                .build();
        
        com.example.dcs.credential.dto.waltid.OnboardIssuerRequest request = 
            com.example.dcs.credential.dto.waltid.OnboardIssuerRequest.builder()
                .key(keyConfig)
                .did(didConfig)
                .build();
        
        ResponseEntity<com.example.dcs.credential.dto.waltid.OnboardIssuerResponse> response = 
            executeOperation(
    ...
    public String issueJwtCredential(
            com.example.dcs.credential.dto.waltid.IssueCredentialRequest request) 
            throws ExternalServiceException {
    ...
    private com.example.dcs.credential.dto.waltid.OnboardIssuerResponse onboardIssuerFallback(
    ...
    /**
     * Fallback for {@link #issueJwtCredential(com.example.dcs.credential.dto.waltid.IssueCredentialRequest, String)}
     * and {@link #issueSdJwtCredential(com.example.dcs.credential.dto.waltid.IssueCredentialRequest, String)}.
     */
    @SuppressWarnings("unused")
    ...
    public String issueUniversityDegreeCredential(
            com.example.dcs.credential.dto.UniversityDegreeCredentialRequest degreeRequest) 
            throws ExternalServiceException {
        ...
        com.example.dcs.credential.dto.waltid.UniversityDegreeData degreeData = 
            com.example.dcs.credential.dto.waltid.UniversityDegreeData.builder()
        ...
        Map<String, Object> credentialData = 
            com.example.dcs.credential.builder.CredentialDataBuilder
        ...
        com.example.dcs.credential.dto.waltid.CredentialMapping mapping = 
            com.example.dcs.credential.builder.CredentialDataBuilder.buildDefaultMapping();
        
        // Build issuance request
        com.example.dcs.credential.dto.waltid.IssueCredentialRequest request = 
            com.example.dcs.credential.dto.waltid.IssueCredentialRequest.builder()
     ...
     */
    private com.example.dcs.credential.dto.waltid.IssuerKey convertToIssuerKey(Object keyObject) {
        if (keyObject == null) {
        ...
        try {
            ...
            if (keyObject instanceof com.example.dcs.credential.dto.waltid.IssuerKey) {
                return (com.example.dcs.credential.dto.waltid.IssuerKey) keyObject;
            }
            ...
            if (keyObject instanceof Map) {
                ...
                com.example.dcs.credential.dto.waltid.IssuerKey.IssuerKeyBuilder builder = 
                    com.example.dcs.credential.dto.waltid.IssuerKey.builder().type(type);
                ...
                if ("jwk".equals(type)) {
                    ...
                    if (jwkObj instanceof Map) {
                        ...
                        com.example.dcs.credential.dto.waltid.JwkKey jwk = 
                            com.example.dcs.credential.dto.waltid.JwkKey.builder()
                ...
                com.example.dcs.credential.dto.waltid.IssuerKey result = builder.build();
    ...
    public String issueEducationalIdCredential(
            com.example.dcs.credential.dto.EducationalIdCredentialRequest eduIdRequest) 
            throws ExternalServiceException {
        ...
        // Build credential data
        com.example.dcs.credential.dto.waltid.EducationalIdData eduIdData = 
            com.example.dcs.credential.dto.waltid.EducationalIdData.builder()
                .id(identifier)
    ...
    public String issueEuropeanStudentCardCredential(
            com.example.dcs.credential.dto.EuropeanStudentCardRequest escRequest) 
            throws ExternalServiceException {
        ...
        // Build credential data
        com.example.dcs.credential.dto.waltid.EuropeanStudentCardData escData = 
            com.example.dcs.credential.dto.waltid.EuropeanStudentCardData.builder()
