...
public class StudentLoginProducer {
     ...
     * @throws com.example.dcs.student.exception.StudentServiceException if Kafka publishing fails
     */
    public void publishStudentLogin(String correlationId, LoginRequest request) {
        ...
        try {
            ...
            throw new com.example.dcs.student.exception.StudentServiceException(
                com.example.dcs.student.exception.ErrorCodes.KAFKA_PRODUCE_ERROR,
