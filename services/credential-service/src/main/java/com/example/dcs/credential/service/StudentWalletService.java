...
public class StudentWalletService {
    ...
    private String extractEmail(Map<String, Object> studentData) {
        return com.example.dcs.credential.mapper.StudentDataMapper.extractString(
    ...
    private String extractFullName(Map<String, Object> studentData) {
        String name = com.example.dcs.credential.mapper.StudentDataMapper.extractString(
    ...
    private String extractStudentId(Map<String, Object> studentData) {
        ...
        String normalized = com.example.dcs.credential.mapper.StudentDataMapper.normalizeStudentId(studentId);
