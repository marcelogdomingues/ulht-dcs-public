...
import com.example.dcs.sis.generated.api.StudentServicesApi;
...
public class StudentServicesController implements StudentServicesApi {
    ...
    public StudentServicesController(SisService sisService) {
    ...
    public ResponseEntity<StudentEnrolments> getStudentEnrolments(@Valid StudentServiceRequest studentServiceRequest) {
        ...
        try {
            ...
            com.example.dcs.sis.domain.student.StudentEnrolments domainResult = 
                sisService.getStudentEnrolments(requestMap);
    ...
    public ResponseEntity<StudentSchedule> getStudentSchedule(@Valid StudentServiceRequest studentServiceRequest) {
        ...
        try {
            Map<String, Object> requestMap = convertToMap(studentServiceRequest);
            com.example.dcs.sis.domain.student.StudentSchedule domainResult = 
                sisService.getUserScheduleSemester(requestMap);
    ...
    public ResponseEntity<StudentGrades> getStudentGrades(@Valid StudentServiceRequest studentServiceRequest) {
        ...
        try {
            Map<String, Object> requestMap = convertToMap(studentServiceRequest);
            com.example.dcs.sis.domain.student.StudentGrades domainResult = 
                sisService.getSIGESGrades(requestMap);
    ...
    public ResponseEntity<StudentEvaluations> getStudentEvaluations(@Valid StudentServiceRequest studentServiceRequest) {
        ...
        try {
            Map<String, Object> requestMap = convertToMap(studentServiceRequest);
            com.example.dcs.sis.domain.student.StudentEvals domainResult = 
                sisService.getSIGESStudentEvals(requestMap);
    ...
    public ResponseEntity<StudentCourseCredits> getStudentCourseCredits(@Valid StudentServiceRequest studentServiceRequest) {
        ...
        try {
            Map<String, Object> requestMap = convertToMap(studentServiceRequest);
            com.example.dcs.sis.domain.student.StudentCourseCredits domainResult = 
                sisService.getStudentCourseCredits(requestMap);
    ...
    private StudentEnrolments convertToApiModel(com.example.dcs.sis.domain.student.StudentEnrolments domain) {
        if (domain == null) {
        ...
        if (domain.enrolmentList() != null) {
            domain.enrolmentList().forEach(enrolment -> {
                com.example.dcs.sis.generated.model.Enrolment apiEnrolment = 
                    new com.example.dcs.sis.generated.model.Enrolment();
    ...
    private StudentSchedule convertToApiModel(com.example.dcs.sis.domain.student.StudentSchedule domain) {
        if (domain == null) {
            ...
            domain.schedule().forEach(scheduleEntry -> {
                ...
                if (scheduleEntry.schedule() != null) {
                    scheduleEntry.schedule().forEach(classSchedule -> {
                        com.example.dcs.sis.generated.model.ScheduleItem apiItem = 
                            new com.example.dcs.sis.generated.model.ScheduleItem();
    ...
    private StudentGrades convertToApiModel(com.example.dcs.sis.domain.student.StudentGrades domain) {
        if (domain == null) {
            ...
            domain.gradeList().forEach(gradeList -> {
                if (gradeList.grades() != null) {
                    gradeList.grades().forEach(grade -> {
                        com.example.dcs.sis.generated.model.Grade apiGrade = 
                            new com.example.dcs.sis.generated.model.Grade();
    ...
    private StudentEvaluations convertToApiModel(com.example.dcs.sis.domain.student.StudentEvals domain) {
        if (domain == null) {
                    ...
                    evaluation.classList().forEach(classItem -> {
                        ...
                        if (classItem.evaluationList() != null) {
                            classItem.evaluationList().forEach(evalDetail -> {
                                com.example.dcs.sis.generated.model.Evaluation apiEvaluation = 
                                    new com.example.dcs.sis.generated.model.Evaluation();
    ...
    private StudentCourseCredits convertToApiModel(com.example.dcs.sis.domain.student.StudentCourseCredits domain) {
        if (domain == null) {
