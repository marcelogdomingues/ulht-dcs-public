...
import com.example.dcs.sis.generated.model.ErrorResponse;
import com.example.dcs.sis.generated.model.ValidationError;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(SisApiException.class)
    public ResponseEntity<ErrorResponse> handleSisApiException(SisApiException ex, WebRequest request) {
        log.error("Sis API error: {} - {} (Context: {})", 
        ...
        errorResponse.setErrorCode("SIS_API_ERROR_" + ex.getErrorCode().getCode());
        
        // Map Sis error codes to appropriate HTTP status codes
