...
import com.example.dcs.sis.domain.workflow.CredentialWorkflowRequest;
...
public class KafkaConfig {
    ...
    public ConsumerFactory<String, Map<String, Object>> mapConsumerFactory() {
        ...
        props.put(ConsumerConfig.GROUP_ID_CONFIG, "sis-service-group");
        // Restrict trusted packages instead of "*". Messages deserialize to java.util.HashMap.
        props.put(JsonDeserializer.TRUSTED_PACKAGES, "com.example.dcs.sis,java.util,java.lang");
