package com.example.dcs.sis.domain.authentication;
...
import com.example.dcs.sis.dto.common.BaseResponse;
...
public class LoginResponse extends BaseResponse {
    ...
    public static class UserProfile {
        ...
        @Schema(description = "User email", example = "joao.silva@usis.pt")
        @JsonProperty("email")
        ...
        @Schema(description = "Institution name", example = "DCS")
