...
public class DeviceInfo extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static pt.ulusofona.digital.wallet.domain.avro.DeviceInfo.Builder newBuilder() {
    return new pt.ulusofona.digital.wallet.domain.avro.DeviceInfo.Builder();
  }
   ...
   * @return A new DeviceInfo RecordBuilder
   */
  public static pt.ulusofona.digital.wallet.domain.avro.DeviceInfo.Builder newBuilder(pt.ulusofona.digital.wallet.domain.avro.DeviceInfo.Builder other) {
    if (other == null) {
      return new pt.ulusofona.digital.wallet.domain.avro.DeviceInfo.Builder();
    } else {
      return new pt.ulusofona.digital.wallet.domain.avro.DeviceInfo.Builder(other);
    }
  }
   ...
   * @return A new DeviceInfo RecordBuilder
   */
  public static pt.ulusofona.digital.wallet.domain.avro.DeviceInfo.Builder newBuilder(pt.ulusofona.digital.wallet.domain.avro.DeviceInfo other) {
    if (other == null) {
      return new pt.ulusofona.digital.wallet.domain.avro.DeviceInfo.Builder();
    } else {
      return new pt.ulusofona.digital.wallet.domain.avro.DeviceInfo.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<DeviceInfo>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(pt.ulusofona.digital.wallet.domain.avro.DeviceInfo.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(pt.ulusofona.digital.wallet.domain.avro.DeviceInfo other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.deviceModel)) {
        this.deviceModel = data().deepCopy(fields()[0].schema(), other.deviceModel);
    ...
    /**
      ...
      * @return This builder.
      */
    public pt.ulusofona.digital.wallet.domain.avro.DeviceInfo.Builder setDeviceModel(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public pt.ulusofona.digital.wallet.domain.avro.DeviceInfo.Builder clearDeviceModel() {
      deviceModel = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public pt.ulusofona.digital.wallet.domain.avro.DeviceInfo.Builder setOsVersion(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public pt.ulusofona.digital.wallet.domain.avro.DeviceInfo.Builder clearOsVersion() {
      osVersion = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public pt.ulusofona.digital.wallet.domain.avro.DeviceInfo.Builder setDeviceId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public pt.ulusofona.digital.wallet.domain.avro.DeviceInfo.Builder clearDeviceId() {
      deviceId = null;
