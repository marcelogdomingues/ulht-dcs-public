package pt.ulusofona.digital.wallet.domain.workflow;
 ...
 * Sent from ULHT Proxy to Credential Service via Kafka.
 */
@Data
@Builder
@NoArgsConstructor
...
public class CredentialWorkflowRequest {
    ...
    @Schema(description = "Student data from external ULHT services")
    ...
    @Schema(description = "Source service that initiated the request", example = "ulht-proxy")
    @JsonProperty("source")
