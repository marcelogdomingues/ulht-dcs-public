...
public class OpenApiConfig {
    ...
    public OpenAPI customOpenAPI() {
        return new OpenAPI()
                .info(new Info()
                        .title("ULHT Digital Wallet API")
                        .description("""
                            # ULHT Digital Wallet API
                            
                            This API provides comprehensive integration between ULHT (Universidade Lusófona de Humanidades e Tecnologias) 
                ...
                .servers(List.of(
                        ...
                        new Server()
                                .url("https://api.ulusofona.pt")
                                .description("Production server - live environment"),
                        new Server()
                                .url("https://staging-api.ulusofona.pt")
                ...
                .externalDocs(new ExternalDocumentation()
                        .description("ULHT Digital Wallet Documentation")
                        .url("https://docs.ulusofona.pt/digital-wallet"))
                .tags(List.of(
                        new Tag()
                                ...
                                .externalDocs(new io.swagger.v3.oas.models.ExternalDocumentation()
                                        ...
                                        .url("https://docs.ulusofona.pt/student-services")),
                        new Tag()
                                .name("Authentication")
                        ...
                        new Tag()
                                ...
                                .externalDocs(new io.swagger.v3.oas.models.ExternalDocumentation()
                                        ...
                                        .url("https://docs.ulusofona.pt/kafka-integration")),
                        new Tag()
                                .name("System")
