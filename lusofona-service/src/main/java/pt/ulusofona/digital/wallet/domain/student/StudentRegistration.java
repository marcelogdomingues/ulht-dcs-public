...
import pt.ulusofona.digital.wallet.dto.common.BaseEntity;
import pt.ulusofona.digital.wallet.validation.ValidStudentCode;
...
public class StudentRegistration extends BaseEntity {
    ...
    @Schema(description = "Student email address", example = "joao.silva@ulusofona.pt")
    ...
    @Schema(description = "Institution name", example = "Universidade Lusófona de Humanidades e Tecnologias")
